...
func (apiCfg *apiConfig) handlerGetFeedFollows(
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Error querying feeds: %v", err))
		return
	}
...
func (apiCfg *apiConfig) handlerDeleteFeedFollow(
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Error parsing feed_id: %v", err))
		return
	}
	...
	if err != nil {
		respondWithError(w, 400, fmt.Sprintf("Error removing feed follow: %v", err))
		return
	}
